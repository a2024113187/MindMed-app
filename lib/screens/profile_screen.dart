...
class _ProfileScreenState extends State<ProfileScreen> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildInfoRow(Icons.info_outline, 'About Me',
                        userData?['aboutMe'] ?? 'No information provided', colors, textTheme,
                        isMultiline: true),
                  ],
                ),
              ),
  ...
  Widget _buildInfoRow(IconData icon, String label, String value, ColorScheme colors, TextTheme textTheme,
